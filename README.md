...
11. **Визуализация в виде дашборда.**
    Интерактивный веб-интерфейс с использованием библиотеки Streamlit для управления параметрами и удобного переключения между графиками в одном окне.
